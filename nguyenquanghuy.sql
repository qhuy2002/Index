...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2023 at 03:45 PM
...
INSERT INTO `tbl_diemhocphan` (`ma_sv`, `ma_hp`, `A`, `B`, `C`) VALUES
...
CREATE TABLE `tbl_khoa` (
  `ma_khoa` int(4) NOT NULL,
  `ten_khoa` varchar(36) DEFAULT NULL,
  `dt` varchar(17) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `tbl_khoa` (`ma_khoa`, `ten_khoa`, `dt`) VALUES
...
CREATE TABLE `tbl_lopchuyennghanh` (
  ...
  `ten_lop` varchar(45) DEFAULT NULL,
  `nien_khoa` varchar(3) DEFAULT NULL,
  `si_so` int(2) DEFAULT NULL,
  `ma_khoa` int(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Table structure for table `tbl_lophocphan`
--

CREATE TABLE `tbl_lophocphan` (
  `ma_lop` varchar(10) NOT NULL,
  `ma_hp` int(7) DEFAULT NULL,
  `nhom` int(1) DEFAULT NULL,
  `hocki` int(1) DEFAULT NULL,
  `namhoc` varchar(9) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `tbl_lophocphan`
--

INSERT INTO `tbl_lophocphan` (`ma_lop`, `ma_hp`, `nhom`, `hocki`, `namhoc`) VALUES
...
INSERT INTO `tbl_sinhvien` (`ma_sv`, `ho_lot`, `ten`, `dt`, `email`, `ma_lop`) VALUES
...
ALTER TABLE `tbl_lopchuyennghanh`
  ...
  ADD KEY `Mã khoa` (`ma_khoa`);

--
-- Indexes for table `tbl_lophocphan`
--
...
--
ALTER TABLE `tbl_diemhocphan`
  ADD CONSTRAINT `qh_sinhvien` FOREIGN KEY (`ma_sv`) REFERENCES `tbl_sinhvien` (`ma_sv`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_diemhocphan` FOREIGN KEY (`ma_hp`) REFERENCES `tbl_hocphan` (`ma_hp`);

--
-- Constraints for table `tbl_lopchuyennghanh`
--
ALTER TABLE `tbl_lopchuyennghanh`
  ADD CONSTRAINT `tbl_lopchuyennghanh` FOREIGN KEY (`ma_khoa`) REFERENCES `tbl_khoa` (`ma_khoa`);

--
-- Constraints for table `tbl_lophocphan`
--
ALTER TABLE `tbl_lophocphan`
  ADD CONSTRAINT `tbl_lophocphan` FOREIGN KEY (`ma_lop`) REFERENCES `tbl_lopchuyennghanh` (`ma_lop`);
...
--- Truy vấn điểm của sinh viên A >= 5, B > 5, C >=6
SELECT `ma_sv`, `ma_hp`, `A`, `B`, `C` 
FROM `tbl_diemhocphan` 
WHERE `A` >= 5 OR `B` > 5 OR `C` >=6;


--- Truy vấn tìm những sinh viên học ở lớp DCCTKH65A
SELECT `ma_sv`, `ho_lot`, `ten`, `dt`, `email`, `ma_lop` 
FROM `tbl_sinhvien` 
WHERE `ma_lop` = 'DCCTKH65A';


--- Truy vấn tìm những môn học có số tín chỉ >=3
SELECT `ma_hp`, `ten_hp`, `tc` 
FROM `tbl_hocphan` 
WHERE `tc` >= 3;